...
'''
with open ('boxDatas.csv','w', newline='') as f:
    wr=csv.writer(f, quoting =csv.QUOTE_ALL)
    wr.writerow(("roiID","label","xmin","ymin","xmax","ymax","x","y","z"))
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        for detection in detections:
            ...
            coord= (roiID,label,xmin,ymin,xmax,ymax,detection.spatialCoordinates.x, detection.spatialCoordinates.y, detection.spatialCoordinates.z)
            coords= list(coord)
