...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        #move to roi and feed in para of bounding box#####
        ...
        if len(detections) != 0:
            ...
            for roiID,roiData in enumerate(roiDatas):
                ...
                depthFrame = depth.getFrame()
                #print("z", roi.spatialCoordinates.z)
        ...
        for detection in detections:
            ...
            #get average z for bounding box
            #################################################
        ...
        if cv2.waitKey(1) == ord('q'):
            df = pd.DataFrame(xyzData)
            df.to_csv('xyzData.csv')
            break